#!/usr/bin/env python3
"""Skeleton for exp_pierre_microskill_detector_pool. See MATH.md for full architecture, predictions,
...
def main():
    t0 = time.time()
    print(f"=== exp_pierre_microskill_detector_pool (SKELETON) ===", flush=True)
