"""K=3 strategy-only composition (skill stack interference test)."""
...
def main():
    run_pierre_compose_experiment(
        method=MethodSpec(
            name="fisher_rao_K3_strategy_only",
            kind="b_only",
        ...
        kc_thresholds={
            ...
            "k4_label": "K=3 strategy-only (no domain)",
            "k4_value": None,
            "k4_threshold": None,
        },
        out_path=EXP_DIR / "results.json",
        extra_config={"K": 3, "axis": "strategy_only"},
        adapter_names_override=["strategy_full", "strategy_prepare", "strategy_act"],
    )
